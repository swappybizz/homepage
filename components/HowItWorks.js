...
const AnalysisIcon = ({ className }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 20 20">
    ...
    <path d="M5 3a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V8a1 1 0 10-2 0v7a1 1 0 01-1 1H5a1 1 0 01-1-1V5a1 1 0 011-1h7a1 1 0 100-2H5z"></path>
  </svg>
);
...
const stepsData = [
  {
    id: 1,
    title: "Install & Secure Login",
    description:
      "Easily install the Cold Eye Review app on any supported device (Android, iOS or Web-PWA). Use secure keys to access the platform's AI features.",
    icon: InstallIcon,
  },
  {
    id: 2,
    title: "Initiate Audit & Capture",
    description:
      "Start a new audit session. Use the intuitive interface to capture high-quality images and audio evidence securely.",
    icon: CaptureIcon,
  },
  {
    id: 3,
    ...
    description:
      "Leverage built-in AI tools to analyze footage, detect anomalies, or transcribe audio during or after capture.",
    icon: AnalysisIcon,
  },
  {
    id: 4,
    ...
    description:
      "Compile findings into a secure, encrypted report. Share instantly with authorized stakeholders through the platform.",
    icon: ReportIcon,
  },
];
// -------------------------------------------------------------
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 md:mb-24">
          ...
          <h2
            className={`text-base font-semibold text-[${colors.crimson}] tracking-wide uppercase`}
          >
            Simple Process
          </h2>
          <p
            className={`mt-2 text-3xl font-extrabold text-[${colors.gold}] sm:text-4xl tracking-tight`}
          >
            How Cold Eye Review Works
          </p>
          <p
            className={`mt-4 max-w-2xl mx-auto text-xl text-[${colors.mediumText}]`}
          >
            ...
            {stepsData.map((step, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <h3
                      className={`text-2xl font-bold text-[${colors.gold}] mb-2 hover:underline transition-all duration-500 cursor-pointer`}
                    >
                      {step.title}
                    </h3>
                  ...
                  <div
                    className={`relative flex justify-center items-center mt-6 md:mt-0 ${
                      isOdd
                        ? "md:col-start-1 md:row-start-1 md:justify-end md:pr-12"
                        : "md:col-start-2 md:row-start-1 md:justify-start md:pl-12"
                    }`}
                  >
                    ...
                    <motion.div
                      ...
                      style={{
                        backgroundColor: useTransform(
                          dotOpacity(index + 1),
                          [0.2, 1],
                          [colors.iconBg, colors.gold]
                        ),
                      }}
                    />
                    {/* Actual Icon */}
                    <div
                      className={`relative z-20 flex items-center justify-center w-16 h-16 rounded-full bg-[${colors.iconBg}] border-2 border-[${colors.gold}]/50 shadow-xl`}
                    >
                      <IconComponent
                        className={`w-8 h-8 text-[${colors.gold}]`}
                      />
                    </div>
                  </div>
                </motion.div>
